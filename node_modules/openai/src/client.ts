...
import type { RequestInit, RequestInfo, BodyInit } from 'openai/src/internal/builtin-types';
import type { HTTPMethod, PromiseOrValue, MergedRequestInit, FinalizedRequestInit } from 'openai/src/internal/types';
import { uuid4 } from 'openai/src/internal/utils/uuid';
import { validatePositiveInteger, isAbsoluteURL, safeJSON } from 'openai/src/internal/utils/values';
import { sleep } from 'openai/src/internal/utils/sleep';
export type { Logger, LogLevel } from 'openai/src/internal/utils/log';
import { castToError, isAbortError } from 'openai/src/internal/errors';
import type { APIResponseProps } from 'openai/src/internal/parse';
import { getPlatformHeaders } from 'openai/src/internal/detect-platform';
import * as Shims from 'openai/src/internal/shims';
import * as Opts from 'openai/src/internal/request-options';
import { stringifyQuery } from 'openai/src/internal/utils/query';
import { VERSION } from 'openai/src/version';
import * as Errors from 'openai/src/core/error';
import * as Pagination from 'openai/src/core/pagination';
import type { WorkloadIdentity } from 'openai/src/auth/types';
import { WorkloadIdentityAuth } from 'openai/src/auth/workload-identity-auth';
import { OAuthError, SubjectTokenProviderError } from 'openai/src/core/error';
import {
  AbstractPage,
  ...
  CursorPageResponse,
  PageResponse,
} from 'openai/src/core/pagination';
import * as Uploads from 'openai/src/core/uploads';
import * as API from 'openai/src/resources/index';
...
import {
  ...
  Batches,
  BatchesPage,
} from 'openai/src/resources/batches';
import {
  Completion,
  CompletionChoice,
  ...
  CompletionUsage,
  Completions,
} from 'openai/src/resources/completions';
import {
  ...
  EmbeddingModel,
  Embeddings,
} from 'openai/src/resources/embeddings';
import {
  FileContent,
  FileCreateParams,
  FileDeleted,
  ...
  FilePurpose,
  Files,
} from 'openai/src/resources/files';
import {
  Image,
  ...
  Images,
  ImagesResponse,
} from 'openai/src/resources/images';
import { Model, ModelDeleted, Models, ModelsPage } from 'openai/src/resources/models';
import {
  Moderation,
  ...
  ModerationTextInput,
  Moderations,
} from 'openai/src/resources/moderations';
import {
  ...
  Videos,
  VideosPage,
} from 'openai/src/resources/videos';
import { Audio, AudioModel, AudioResponseFormat } from 'openai/src/resources/audio/audio';
import { Beta } from 'openai/src/resources/beta/beta';
import { Chat } from 'openai/src/resources/chat/chat';
import {
  ...
  Containers,
} from 'openai/src/resources/containers/containers';
import { Conversations } from 'openai/src/resources/conversations/conversations';
import {
  EvalCreateParams,
  EvalCreateResponse,
  ...
  EvalUpdateResponse,
  Evals,
} from 'openai/src/resources/evals/evals';
import { FineTuning } from 'openai/src/resources/fine-tuning/fine-tuning';
import { Graders } from 'openai/src/resources/graders/graders';
import { Realtime } from 'openai/src/resources/realtime/realtime';
import { Responses } from 'openai/src/resources/responses/responses';
import {
  DeletedSkill,
  Skill,
  SkillCreateParams,
  ...
  Skills,
  SkillsPage,
} from 'openai/src/resources/skills/skills';
import {
  Upload,
  UploadCompleteParams,
  UploadCreateParams,
  Uploads as UploadsAPIUploads,
} from 'openai/src/resources/uploads/uploads';
import {
  ...
  VectorStores,
  VectorStoresPage,
} from 'openai/src/resources/vector-stores/vector-stores';
import { Webhooks } from 'openai/src/resources/webhooks/webhooks';
import {
  ChatCompletion,
...
import { type Fetch } from 'openai/src/internal/builtin-types';
import { isRunningInBrowser } from 'openai/src/internal/detect-platform';
import { HeadersLike, NullableHeaders, buildHeaders } from 'openai/src/internal/headers';
import { FinalRequestOptions, RequestOptions } from 'openai/src/internal/request-options';
import { readEnv } from 'openai/src/internal/utils/env';
import {
  type LogLevel,
  type Logger,
  ...
  loggerFor,
  parseLogLevel,
} from 'openai/src/internal/utils/log';
import { isEmptyObj } from 'openai/src/internal/utils/values';
