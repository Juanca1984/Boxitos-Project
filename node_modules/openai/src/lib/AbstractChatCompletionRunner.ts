import { OpenAIError } from 'openai/src/error';
import type OpenAI from 'openai/src';
import type { RequestOptions } from 'openai/src/internal/request-options';
import { isAutoParsableTool, parseChatCompletion } from 'openai/src/lib/parser';
import type {
  ChatCompletion,
...
import type { ChatCompletionToolRunnerParams } from 'openai/src/lib/ChatCompletionRunner';
import type { ChatCompletionStreamingToolRunnerParams } from 'openai/src/lib/ChatCompletionStreamingRunner';
import { isAssistantMessage, isToolMessage } from 'openai/src/lib/chatCompletionUtils';
import { BaseEvents, EventStream } from 'openai/src/lib/EventStream';
import {
