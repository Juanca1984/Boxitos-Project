...
export * from 'openai/src/resources/chat/completions/completions';
export { Messages, type MessageListParams } from 'openai/src/resources/chat/completions/messages';
