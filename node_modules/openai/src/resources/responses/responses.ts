...
import {
  ...
  addOutputText,
} from 'openai/src/lib/ResponsesParser';
import { ResponseStream, ResponseStreamParams } from 'openai/src/lib/responses/ResponseStream';
import { APIResource } from 'openai/src/core/resource';
import * as ResponsesAPI from 'openai/src/resources/responses/responses';
import * as Shared from 'openai/src/resources/shared';
import * as InputItemsAPI from 'openai/src/resources/responses/input-items';
import { InputItemListParams, InputItems, ResponseItemList } from 'openai/src/resources/responses/input-items';
import * as InputTokensAPI from 'openai/src/resources/responses/input-tokens';
import { InputTokenCountParams, InputTokenCountResponse, InputTokens } from 'openai/src/resources/responses/input-tokens';
import { APIPromise } from 'openai/src/core/api-promise';
import { CursorPage } from 'openai/src/core/pagination';
import { Stream } from 'openai/src/core/streaming';
import { buildHeaders } from 'openai/src/internal/headers';
