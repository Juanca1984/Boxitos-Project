...
import * as ContentAPI from 'openai/src/resources/skills/versions/content';
import { Content, ContentRetrieveParams } from 'openai/src/resources/skills/versions/content';
